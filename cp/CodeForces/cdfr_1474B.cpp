...
void soln(ll t){
    ...
    I_ n;
    a=1+n;
    b=lower_bound(prime_list.begin(),prime_list.end(),a)-prime_list.begin();
    if(prime_list[b]!=a)a=prime_list[b];
    b=a+n;
    c=lower_bound(prime_list.begin(),prime_list.end(),b)-prime_list.begin();
    if(prime_list[c]!=b)b=prime_list[c];
