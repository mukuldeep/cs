...
void soln(ll t){
    ll m,n,k,a=LONG_LONG_MIN,b=LONG_LONG_MAX,c=LONG_LONG_MIN,u,d=LONG_LONG_MAX,l,r,cnt=0,ans=0,mn=LONG_LONG_MAX,mx=LONG_LONG_MIN;
    I n>>m;
    V(S) str(n);
    Fi(i,0,n) {
        I str[i];
