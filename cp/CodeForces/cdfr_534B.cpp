...
void soln(ll t){
    ll m,n,k,a,b,c,u,d,l,r,v1,v2,cnt=0,ans=0,mn=LONG_LONG_MAX,mx=LONG_LONG_MIN;
    I v1>>v2>>t>>d;
    V(ll) arr_max(t),barr_max(t);
    arr_max[0]=v1;
    barr_max[t-1]=v2;
    Fi(i,1,t){
       arr_max[i]=arr_max[i-1]+d;
       barr_max[t-i-1]=barr_max[t-i]+d;
    }
    F(i,t){
        ans+=min(arr_max[i],barr_max[i]);
    }
    O ans<<El
}
