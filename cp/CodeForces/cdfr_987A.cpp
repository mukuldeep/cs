...
ll col_no(S col){
    if(col=="purple")return 0;
    if(col== "green")return 1;
    if(col== "blue")return 2;
    if(col== "orange")return 3;
    if(col== "red")return 4;
    if(col== "yellow") return 5;
}
S pow_no(ll col){
    if(col==0)return "Power";
    if(col==1)return "Time";
    if(col==2)return "Space";
    if(col==3)return "Soul";
    if(col==4)return "Reality";
    if(col==5) return "Mind";
}
void soln(ll t){
