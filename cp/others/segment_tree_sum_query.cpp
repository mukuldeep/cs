...
void soln(ll t){
    ...
    string str;
    //I_ n;
    vll arr={1,2,3,4,5,6,7,8};
    segment_tree_sum stm=segment_tree_sum(arr);
//    stm.print_seg_tree();
//    stm.print_arr();
    stm.update(5,10);
//    stm.print_seg_tree();
//    stm.print_arr();
    O_ stm.find_sum(2,5)<<EL
    O_ stm.find_sum(0,0)<<EL
    O_ stm.find_sum(1,7)<<EL
    O_ stm.find_sum(0,7)<<EL
    O_ stm.find_sum(3,6)<<EL
