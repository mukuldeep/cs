...
public class leet_CountSubarraysWithMajorityElementii {
    ...
    public static long countMajoritySubarrays(int[] nums, int target) {
        ...
        for(int i=0; i<prefixCnt.length; i++){
            ost.insert(prefixCnt[i]);
            int ord = ost.order_of_key(prefixCnt[i]);
    ...
    public static void main(String[] args){
        ...
        long ans = countMajoritySubarrays(nums, target);
