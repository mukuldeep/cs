...
int cc_main() {
    ...
    freopen("../external_files/contests/hashcode 2022/inout/b_output.txt", "a", stdout);
    freopen(("../external_files/contests/hashcode 2022/inout/b.txt"), "r", stdin);
    soln();
